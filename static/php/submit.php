...
if(isset($_POST['url']) && $_POST['url'] == '' && $_POST['message'] != ''){
	...
	$youremail = 'info@designkungfu.com';
...
header('Location: https://www.designkungfu.com/thank-you.html');
exit('Redirecting you to https://www.designkungfu.com/thank-you.html');
